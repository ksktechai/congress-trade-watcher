...
@Tag(
    name = "Signals",
    description = "Rule-based patterns for research only — never recommendations")
public class SignalResource {
  ...
  public List<SignalDto> list(
      @QueryParam("type") SignalType type, @QueryParam("ticker") String ticker) {
  ...
  @Path("/detect")
  @Operation(
      summary = "Re-run pure-code signal detection over the look-back window and persist results")
