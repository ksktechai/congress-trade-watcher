...
@Tag(
    name = "Digest",
    description = "Plain-English daily briefing (narration only, not financial advice)")
public class DigestResource {
  ...
  @Operation(
      summary =
          "Daily digest: LLM narrative over computed trades and signals, plus disclaimer. "
