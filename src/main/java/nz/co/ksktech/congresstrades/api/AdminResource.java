...
public class AdminResource {
    ...
    public AdminResource(CongressDataIngestionService congressIngestion,
    ...
    public IngestResultDto ingest(@QueryParam("source") @DefaultValue("congress") String source,
        ...
        if ("finnhub".equalsIgnoreCase(source)) {
            ...
            result = single ? congressIngestion.ingestTicker(ticker) : congressIngestion.ingestWatchlist();
        }
