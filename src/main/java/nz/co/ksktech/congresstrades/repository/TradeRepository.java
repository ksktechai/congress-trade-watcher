...
public class TradeRepository implements PanacheRepository<Trade> {
     ...
     */
    public List<Trade> search(String memberName, String ticker, TransactionType type,
    ...
    /**
     * Trades disclosed on or after the given date, newest first. Used as the
     * input set for the daily digest and on-demand signal detection.
     */
