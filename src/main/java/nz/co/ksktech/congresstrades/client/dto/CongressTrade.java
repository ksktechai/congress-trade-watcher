...
/**
 * One transaction from the Congress Trading Monitor open dataset
 * (congress.kadoa.com), parsed from the official House Clerk / Senate eFD / OGE
 * STOCK Act filings. {@code id} is a stable unique filing key used directly as
 * our {@code sourceFilingId} for idempotent ingestion.
 *
 * @see <a href="https://github.com/kadoa-org/congress-trading-monitor">kadoa-org/congress-trading-monitor (MIT)</a>
 */
