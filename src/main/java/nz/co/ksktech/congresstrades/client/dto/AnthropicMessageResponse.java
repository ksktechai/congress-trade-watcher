...
/**
 * Response body from Anthropic's {@code POST /v1/messages}. The model's text is delivered as an
 * array of typed {@code content} blocks; {@link #firstText()} extracts the concatenated text.
 */
