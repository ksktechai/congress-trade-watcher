...
/**
 * One element of the Finnhub congressional-trading {@code data} array. Field
 * names mirror the real API exactly; dates arrive as ISO {@code yyyy-MM-dd}
 * strings and are parsed during ingestion.
 *
 * <p>Example element:
 * <pre>
 * {
