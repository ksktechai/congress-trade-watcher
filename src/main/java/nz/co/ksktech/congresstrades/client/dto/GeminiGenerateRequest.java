 ...
 * </pre>
 *
 * <p>{@code thinkingBudget: 0} disables the 2.5-series "thinking" phase, which
 * otherwise consumes the output-token budget and can truncate the narrative.</p>
 *
...
public record GeminiGenerateRequest(
    ...
    /**
     * @param thinkingBudget tokens the model may spend "thinking"; {@code 0} disables
     *                       it, a negative value omits the field (for models that do
     *                       not support thinking config).
     */
