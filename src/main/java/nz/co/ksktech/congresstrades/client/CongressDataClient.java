...
/**
 * Client for the free, no-key Congress Trading Monitor open dataset
 * (congress.kadoa.com), which serves real STOCK Act disclosures as static
 * per-ticker JSON. Same fault-tolerance ring as the other external clients.
 *
