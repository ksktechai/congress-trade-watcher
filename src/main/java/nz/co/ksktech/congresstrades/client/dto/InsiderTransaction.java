...
/**
 * One corporate-insider transaction from Finnhub's
 * {@code /stock/insider-transactions} endpoint (SEC Form 3/4/5 data). This is a
 * company insider (officer/director), NOT a member of Congress.
 *
 * <p>{@code transactionCode} follows SEC codes (e.g. {@code P}=purchase,
 * {@code S}=sale, {@code M}=option exercise, {@code A}=grant, {@code G}=gift,
 * {@code D}=disposition).</p>
 */
