...
/**
 * Orchestrates the pure-code {@link SignalDetectionService} against persisted
 * trades: loads the look-back window, runs detection, and replaces the stored
 * signal set so repeated runs stay idempotent.
 */
@ApplicationScoped
public class SignalService {
    ...
    /**
     * Detect over the configured look-back window and persist the results,
     * replacing any previously stored signals.
     */
    @Transactional
