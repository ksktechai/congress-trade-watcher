...
public class AnthropicLlmProvider implements LlmProvider {
  ...
  @Inject @RestClient AnthropicClient anthropicClient;
  ...
  public String generate(String systemPrompt, String userPrompt) {
    ...
    LOG.infof(
        "LLM RESPONSE ← anthropic (%dms, stopReason=%s, chars=%d, tokens in/out=%s/%s)",
        ms,
        response.stopReason(),
        text.length(),
