...
/**
 * Normalised transaction type. Finnhub reports free-text values such as
 * "Purchase", "Sale", "Sale (Full)", "Sale (Partial)", "Exchange"; these are
 * mapped onto this stable enum during ingestion.
 */
